    ...
    const row = await prisma.project.create({
      data: {
        ...
        extraData: JSON.stringify({
          ...
          agencyAssignedAt: p.agencyAssignedAt, agencyAssignedAtHistory: p.agencyAssignedAtHistory,
          internalAssignedAt: p.internalAssignedAt, internalAssignedAtHistory: p.internalAssignedAtHistory,

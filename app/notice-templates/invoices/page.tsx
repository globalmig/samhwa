...
// "기타 공문"이 두 탭으로 나뉘어 있는 이유: OTHER(청구서 PDF 양식)는 공문발송의 "기타 공문"에
// 첨부되는 청구서 PDF를 관리하고, OTHER_MAIL(메일)은 그 공문의 제목/본문 자체를 관리한다 — 둘 다
// 여러 건 등록해둘 수 있고, DispatchModal에서 "기타 공문"을 고르면 두 목록에서 각각 하나씩
// 선택할 수 있다(청구서 양식 드롭다운·메일 템플릿 드롭다운).

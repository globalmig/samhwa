...
export async function POST(_request: Request, { params }: Params) {
  ...
  await prisma.auditLog.create({ data: { userId: actor.userId, action: "UPDATE", resourceType: "simpleNoticeTemplate", resourceId: id, newValues: JSON.stringify({ setDefault: true }) } });

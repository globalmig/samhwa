...
export function toProject(p: PrismaProject): Project {
  ...
  return {
    ...
    agencyAssignedAtHistory: (extra.agencyAssignedAtHistory as Project["agencyAssignedAtHistory"]) ?? undefined,
    internalAssignedAt: (extra.internalAssignedAt as string) ?? undefined,
    internalAssignedAtHistory: (extra.internalAssignedAtHistory as Project["internalAssignedAtHistory"]) ?? undefined,

...
export const FIELD_LABELS: Record<string, string> = {
  ...
  deletedTerms:        "삭제된 연차",
  firstStartDate:      "최초시작일",
  finalEndDate:        "최종종료일",
  researchLeadEmail:   "책임자이메일",
  researchLeadOverrides: "연차별 연구책임자",
  termCodes:           "연차별 과제코드",
  billingType:         "발행구분",
  autonomySettlementType: "자율성트랙 정산구분",
  programType:         "사업 유형",
  contactName:         "담당자명",
  ...
  leadName:            "책임자명",
  leadEmail:           "책임자이메일",
  leadOverrides:       "연차별 책임자",
  docRequestDate:      "서류요청일",
  docReplyDate:        "서류회신일",
  termStartDate:       "연차시작일",
  termEndDate:         "연차종료일",
  auditFirm:           "담당 회계법인",
  otherFirmHandled:    "타회계법인 진행",
  unclaimedFee:        "미청구수수료",
  standardFee:         "표준수수료",
  manualOverride:      "수동조정 여부",
  manualOverrideReason: "수동조정 사유",
  isAutoGenerated:     "자동생성 여부",
};
